...
// - `creativo` arranca en el tier alto. Es para lo que decide si el video funciona (el guion) y
//   para la comprensión multimodal (la lectura). Ahorrar acá es arriesgar mucho por nada: el
//   guion cuesta ~$0.0045 contra ~$0.0007 en lite, o sea poco más de un dólar al mes a 10
//   videos diarios, y `PROMPTS.guion` está afinado para este modelo.
// - `mecanico` arranca en lite (~6x más barato) y ESCALA al tier alto si lite falla. Es para
//   tareas pautadas donde el modelo no inventa nada: fragmentar, etiquetar, nombrar archivos.
//   Evidencia de que alcanza: durante las pruebas de la Fase 2 la cadena cayó sola hasta
//   `gemini-3.1-flash-lite-preview` y la fragmentación salió igual de bien.
const CADENAS = {
...
module.exports = {
  ...
  TAREAS,   // router de modelos: agregar acá la entrada de cada llamada nueva (ver Fase 9)
  CADENAS,
  agregarMarcas,
